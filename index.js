...
`
Statement #1:
JS is my first programming language.
`,
`
Statement #2:
I believe second should be HTML.
`,
`
Statement #3:
Or maybe second should be CSS.
`,
`
Statement #4:
I think ESOVA is the best app in the world.
`,
`
Statement #5:
I think i could spend all day programming.
`,
`
Statement #6:
Programming is life changing decision.
`
]
var i               = 0
...
function quizComponent () {
  ...
  function sendData(results) {
    var request  = {
      url          : 'https://quiz-9fab8.firebaseio.com/results.json',
      method       : 'POST',
  ...
  function createChart(ctx, myData) {
    minixhr('https://quiz-9fab8.firebaseio.com/results.json', responseHandler)
